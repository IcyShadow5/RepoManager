...
- the affected RepoManager version or source revision;
- the affected Windows and Python versions, where relevant;
- the prerequisites and steps needed to reproduce the issue;
- the observed impact and affected data or trust boundary;
- logs, screenshots, or a proof of concept with credentials and personal data
  removed;
